		...
		;		Think about when we call functions
		;			- Variables are stored in registers or in memory  with pointers
		;			- When we call functions we obviously don't expect our local variables to be messed with unless they're passed to the function
		;			- Surprisingly, these contracts are implemented at assembly level by the code that is generated by the compiler
